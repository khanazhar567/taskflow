    ...
    <div className="min-h-screen flex">
      ...
      >
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-10 right-10 w-72 h-72 rounded-full opacity-20" style={{ background: 'radial-gradient(circle, #8b5cf6, transparent)', animation: 'blob 9s ease-in-out infinite' }} />
          <div className="absolute bottom-20 left-10 w-56 h-56 rounded-full opacity-15" style={{ background: 'radial-gradient(circle, #06b6d4, transparent)', animation: 'blob 11s ease-in-out infinite 2s' }} />
        </div>
        ...
        <div className="relative z-10 space-y-6">
          {[
            { icon: '⚡', text: 'Real-time updates — see changes the moment they happen' },
            { icon: '📋', text: 'Kanban board with drag-and-drop task management' },
            { icon: '🔐', text: 'Role-based access — admins and standard users' },
          ].map((item) => (
      ...
      <div className="w-full lg:w-1/2 flex flex-col bg-white">
        ...
        <div className="flex items-center justify-between px-8 pt-6">
          ...
          <p className="text-sm text-gray-500">
            ...
            <Link to="/login" className="text-indigo-600 hover:text-indigo-700 font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded">
              Sign in
            </Link>
          </p>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-8 py-12">
          <div className="w-full max-w-md">
            <div className="mb-8">
              ...
              <p className="text-gray-500">Start collaborating with your team today.</p>
            </div>
